...
@NgModule({
    declarations: [GroupComponent, GroupMainComponent, GroupSideBarComponent, GroupMessageHeaderComponent, GroupMessageBodyComponent, CreateGroupModalComponent, UpdateGroupModalComponent, AddMembersModal],
    imports: [
